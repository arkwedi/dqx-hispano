...
def main():
    ...
    # PATCHED by dqx-hispano: comentado para que NO se sobre-escriban
    # glossary.db / clarity_dialog.db con el contenido en ingles de
    # Clarity al iniciar. Ver clarity_patch/original_main.py para la
